...
const HomeScreen = () => {
  ...
  const [checkedTurnOff, setCheckedTurnOff] = React.useState(false);
  ...
  function setTurnOff(checked) {
    setCheckedTurnOff(true);
    setTextTitle('Desligar Modalidade');
    setUrlImage('http://');
    // setCheckedMode(false);
    setCheckedAmblight(false);
    setCheckedRGB(false);
  ...
  function modeAmbilight() {
    BluetoothSerial.write('SET_MODE 1;')
      .then(res => {
        console.log(res);
        console.log('Successfuly wrote to device');
      })
  ...
  function modeColorFull() {
    BluetoothSerial.write('SET_MODE 2;')
      .then(res => {
        console.log(res);
        console.log('Successfuly wrote to device');
      })
      ...
      <View>
        ...
        {checkedMode && (
          <View>
            ...
            <TouchableRipple onPress={() => setTurnOff(!checkedTurnOff)}>
              <View style={styles.row}>
                <Subheading>Desligar Modalidades</Subheading>
                <View pointerEvents="none">
                  <Checkbox
                    color={Colors.blue500}
                    status={checkedTurnOff ? 'checked' : 'unchecked'}
                  />
                </View>
              </View>
            </TouchableRipple>
